// Credit for this code goes to Robin2. 
// Original code can be found at https://forum.arduino.cc/index.php?topic=223286.0


// SeveralThingsAtTheSameTimeRev1.ino    -> renamed to event-based example
